    ...
    Scaffold(
        ...
        Column(
            ...
            Column(
                ...
                ScoreInputField(label = "MATHS", maxScore = 125) { score ->
                    scores.value.maths = score
                }
                ScoreInputField(label = "KHMER", maxScore = 75) { score ->
                    scores.value.khmer = score
                }
                ScoreInputField(label = "PHYSICS", maxScore = 75) { score ->
                    scores.value.physics = score
                }
                ScoreInputField(label = "CHEMISTRY", maxScore = 75) { score ->
                    scores.value.chemistry = score
                }
                ScoreInputField(label = "BIOLOGY", maxScore = 75) { score ->
